	...
	return ( 
		<div className="container plp-container mt-5"> 
			...
			<ul className="row product-list"> 
				...
				<li key={product._id} className="col-md-3 product-mini-outer-container">
							...
							<div className="mini-image-container">
								<div className="product-image-slider-outer-container">
									<picture>
										...
										<img class="primary-image" src={product.images[0]} alt="Blue Striped Lemon Fresh Start T-Shirt" title="Blue Striped Lemon Fresh Start T-Shirt" width="" height="305"/>
									</picture>
								</div>
								<div className="add-to-bag-plp" focusable="true" tabindex="0">
